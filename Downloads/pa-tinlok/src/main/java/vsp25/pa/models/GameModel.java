...
import vsp25.pa.initialization.PointLocation;

import java.awt.geom.Point2D;
import java.util.HashSet;
import java.util.Set;

import static vsp25.pa.models.Model.Stage.*;
...
public class GameModel implements Model, Controllable {
    ...
    private final GraphInterface<Planet, Link> planetGraph; // the graph representation of the universe
