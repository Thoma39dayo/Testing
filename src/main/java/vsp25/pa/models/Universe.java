package vsp25.pa.models;

import vsp25.pa.graph.Graph;
import vsp25.pa.graph.GraphInterface;
import vsp25.pa.initialization.DelaunayTriangulation;
import vsp25.pa.initialization.UEdge;
import vsp25.pa.util.Util;
...
public class Universe {
    ...
    private GraphInterface<Planet, Link> planetGraph;
    ...
    private Universe(int w, int h, long seed, int minPlanets, int maxPlanets, int minSpice,
        ...
        // TODO: Implement pruneRandomEdges in Graph class or handle differently
    ...
    public Set<Link> links() {
        return Collections.unmodifiableSet(planetGraph.getEdges());
    }
    ...
    public int sumLinkLengths() {
        return planetGraph.getTotalEdgeLength();
    }

    public Set<Planet> neighbors(Planet planet) {
        if (planetGraph.hasVertex(planet)) {
            return planetGraph.getNeighbors(planet).keySet();
        } else {
    ...
    public boolean connected(Planet pl1, Planet pl2) {
        return planetGraph.hasEdge(pl1, pl2);
    }
    ...
    /**
     * Returns the graph representation of the universe.
     * 
     * @return the graph representation of the universe
     */
    public GraphInterface<Planet, Link> planetGraph() {
        return planetGraph;
    }
